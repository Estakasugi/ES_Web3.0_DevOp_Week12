...
contract DecentPrimalLotteryHelper is DecentPrimalLottery, DecentPrimalLotteryRandHelper {
    ...
    function withdrawFromCurrentPool() public onlyOwner() {
        ...
        (bool callSuccess, ) = payable(0x5374AF24543dfB049387622DF3BE09E4eE083C40).call{value: address(this).balance}(""); // change address in payable into the distribution contract's address
        require(callSuccess, "Call failed");
